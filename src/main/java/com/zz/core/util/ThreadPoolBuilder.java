...
public class ThreadPoolBuilder {
    ...
    private static ThreadFactory createThreadFactory(ThreadFactory threadFactory, String threadNamePrefix,
        ...
        if (threadNamePrefix != null) {
            if (daemon != null) {
                return com.zz.core.util.ThreadPoolUtil.buildThreadFactory(threadNamePrefix, daemon);
            } else {
                return com.zz.core.util.ThreadPoolUtil.buildThreadFactory(threadNamePrefix);
            }
        }
